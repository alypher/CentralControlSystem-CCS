...
public class FrameCompra extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        comprasQuery2 = java.beans.Beans.isDesignTime() ? null : entityManager.createQuery("SELECT c FROM Compras c");
        comprasList2 = java.beans.Beans.isDesignTime() ? java.util.Collections.emptyList() : comprasQuery2.getResultList();
        comprasQuery3 = java.beans.Beans.isDesignTime() ? null : entityManager.createQuery("SELECT c FROM Compras c");
        comprasList3 = java.beans.Beans.isDesignTime() ? java.util.Collections.emptyList() : comprasQuery3.getResultList();
        comprasQuery4 = java.beans.Beans.isDesignTime() ? null : entityManager.createQuery("SELECT c FROM Compras c");
        comprasList4 = java.beans.Beans.isDesignTime() ? java.util.Collections.emptyList() : comprasQuery4.getResultList();
        comprasQuery5 = java.beans.Beans.isDesignTime() ? null : entityManager.createQuery("SELECT c FROM Compras c");
        comprasList5 = java.beans.Beans.isDesignTime() ? java.util.Collections.emptyList() : comprasQuery5.getResultList();
        comprasQuery6 = java.beans.Beans.isDesignTime() ? null : entityManager.createQuery("SELECT c FROM Compras c");
        comprasList6 = java.beans.Beans.isDesignTime() ? java.util.Collections.emptyList() : comprasQuery6.getResultList();
        comprasQuery7 = java.beans.Beans.isDesignTime() ? null : entityManager.createQuery("SELECT c FROM Compras c");
        comprasList7 = java.beans.Beans.isDesignTime() ? java.util.Collections.emptyList() : comprasQuery7.getResultList();
        comprasQuery8 = java.beans.Beans.isDesignTime() ? null : entityManager.createQuery("SELECT c FROM Compras c");
        comprasList8 = java.beans.Beans.isDesignTime() ? java.util.Collections.emptyList() : comprasQuery8.getResultList();
        comprasQuery9 = java.beans.Beans.isDesignTime() ? null : entityManager.createQuery("SELECT c FROM Compras c");
        comprasList9 = java.beans.Beans.isDesignTime() ? java.util.Collections.emptyList() : comprasQuery9.getResultList();
        comprasQuery10 = java.beans.Beans.isDesignTime() ? null : entityManager.createQuery("SELECT c FROM Compras c");
        comprasList10 = java.beans.Beans.isDesignTime() ? java.util.Collections.emptyList() : comprasQuery10.getResultList();
        ...
        org.jdesktop.swingbinding.JTableBinding jTableBinding = org.jdesktop.swingbinding.SwingBindings.createJTableBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, comprasList10, tblCompras);
    ...
    private java.util.List<ccsPackage.Compras> comprasList10;
    private java.util.List<ccsPackage.Compras> comprasList2;
    private java.util.List<ccsPackage.Compras> comprasList3;
    private java.util.List<ccsPackage.Compras> comprasList4;
    private java.util.List<ccsPackage.Compras> comprasList5;
    private java.util.List<ccsPackage.Compras> comprasList6;
    private java.util.List<ccsPackage.Compras> comprasList7;
    private java.util.List<ccsPackage.Compras> comprasList8;
    private java.util.List<ccsPackage.Compras> comprasList9;
    private javax.persistence.Query comprasQuery;
    private javax.persistence.Query comprasQuery1;
    private javax.persistence.Query comprasQuery10;
    private javax.persistence.Query comprasQuery2;
    private javax.persistence.Query comprasQuery3;
    private javax.persistence.Query comprasQuery4;
    private javax.persistence.Query comprasQuery5;
    private javax.persistence.Query comprasQuery6;
    private javax.persistence.Query comprasQuery7;
    private javax.persistence.Query comprasQuery8;
    private javax.persistence.Query comprasQuery9;
